...
class DATAPROCESS:
    def __init__(self, train_data_path, train_label_path, test_data_path, test_label_path, word_embedings_path,
                 vocb_path, seperate_rate=0.1, batch_size=256):
    ...
    def load_wordebedding(self):
        self.word_embeddings = pl.load(self.word_embedding_path)
    ...
    def load_train_data(self):
        ...
        # assert 表达式 【，参数】表达式为真，程序往下执行，否则程序报错。
...
#     print(dataGen.evaluate(labels, labels, efficient_sequence_length))
