...
class question_ays:
    ...
    def analysis(self,text):
        ...
        # print("data_line,lable_line,efficient_sequence_length", data_line, '\n', lable_line, '\n', efficient_sequence_length)
        for idx in range(len(data_line)):
            ...
            for each in range(efficient_sequence_length[idx]):
                ...
                if _entityType[0]=='B' or  _entityType[0]=='I':
                    ...
                    # print("_entityType_short", _entityType_short)
                    # print("self.state2entityType[_entityType_short]: ", self.state2entityType[_entityType_short])
